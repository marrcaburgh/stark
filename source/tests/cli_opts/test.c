...
struct stark_cli_opt optv[] = {
    ...
    {.type = STARK_CLI_OPT_TYPE_BOOLEAN, .shorthand = 'q', .dest = &q},
    {.type = STARK_CLI_OPT_TYPE_BOOLEAN, .shorthand = 'w', .dest = &w},
    {.type = STARK_CLI_OPT_TYPE_BOOLEAN, .shorthand = 'e', .dest = &e},
    {.type = STARK_CLI_OPT_TYPE_BOOLEAN, .longhand = "r", .dest = &r},
    {.type = STARK_CLI_OPT_TYPE_BOOLEAN, .longhand = "t", .dest = &t},
    {.type = STARK_CLI_OPT_TYPE_BOOLEAN, .longhand = "y", .dest = &y},
    {.type = STARK_CLI_OPT_TYPE_BOOLEAN,
